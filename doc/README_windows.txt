...
Intro
-----
Zio Coin (ZIO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Zio Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ziocoin-qt.exe.

Zio Coin Core is the original Zio Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Zio Coin transactions;
