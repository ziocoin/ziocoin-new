...
In order to support loading of multiple wallets in ziocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ziocoin.cpp.
...
Changes to ziocoin.cpp
----------------------
ziocoin.cpp is the entry point into ziocoin-qt, and as such, will require some minor modifications to provide hooks for
