...
Zio Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ziocoin_address\> \<monthly_payment_ziocoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ZIO, _12_ times over the course of a year totaling _24000_ ZIO.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ziocoin_address\> \<monthly_payment_ziocoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` ZIO.
 ...
 * vote-many          - Vote on a Zio Coin initiative
 * vote-alias         - Vote on a Zio Coin initiative
 * vote               - Vote on a Zio Coin initiative/budget
