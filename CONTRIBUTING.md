Contributing to Zio Coin Core
==================================

The Zio Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zio Coin Core project, and is not to be
confused with overall Zio Coin Network Protocol consensus changes.

Whether a pull request is merged into Zio Coin Core rests with the project merge
...
Patches that change Zio Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zio Coin consensus, it must have been
...
The project leader is the release manager for each Zio Coin Core release.
